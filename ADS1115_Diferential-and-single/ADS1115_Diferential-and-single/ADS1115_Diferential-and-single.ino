...
Biblioteca antigamente utilizada: https://github.com/thingSoC/TSOC_GROVEY_ADC/blob/master/libraries/Adafruit_ADS1X15/Adafruit_ADS1015.h
...
void loop(void) {
  ...
  Serial.println("----------------------------------------------------------------------");
  Serial.print("             ");
  Serial.print(adc0_1 * multiplier); 
  Serial.print("mV                     ");
  Serial.print(adc2 * multiplier);
  Serial.print("mV          ");
  Serial.print(unoA0 * adcScale);
  Serial.println("mV");
