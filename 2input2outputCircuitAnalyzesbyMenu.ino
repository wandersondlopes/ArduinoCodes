...
Codigo foi definido para leitura analogica e digital de uma circuito
logico de duas saidas e duas entradas. Gera-se um relatorio a cada
depois de obeter a opcao 2 ou 3 do menu.
*/
