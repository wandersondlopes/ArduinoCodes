...
Library code found at: https://github.com/adafruit/Adafruit_MCP4725 and https://github.com/adafruit/Adafruit_BusIO
...
// Set this value to 9 to 256 steps of resolution or other number to 512 steps of resolution
